# Jepsen Nats Antithesis Tests

This is a pile of hacks to try and get a Jepsen test for NATS running inside
Antithesis.
...
If you're @aphyr, sync the top-level `jepsen.nats` dir to the EC2 instance. If
you have Docker locally, you can skip this.

```
jepsen-aws instance sync -d jepsen.nats
```
